---
title: "Building a Photography Masonry Page with Next.js & Tailwind"
subtitle: "Create a masonry style photo gallery in nextjs."
date: "2023-03-25"
---

Building a Photography Masonry Page with Next.js. A masonry layout is a popular design pattern that displays content in a grid-like structure with columns of varying heights, creating an aesthetically pleasing and space-efficient way to showcase images.

## Getting Started

> Before we start, we'll need to have the following tools installed: Node.js (v14 or higher), npm (v6 or higher) and A code editor (e.g., Visual Studio Code)
